...
def main(unused_argv):
  ...
  FLAGS.input = os.path.expanduser('/Users/liujiaheng/Desktop/Magenta/out3.tfrecord')
  FLAGS.output_dir = os.path.expanduser('/Users/liujiaheng/Desktop/Magenta/demo1/melody_rnn/sequence_examples')
